...
<div style="position:absolute;left:31.5%; top:54%; font-weight:bold; z-index:1;"> <a href="Profile.php" style="text-decoration:none; color:#E66C5E;" onMouseOver="on_timeline_txt();" onMouseOut="out_timeline_txt();">  Timeline </a> </div>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:26%;top:101%; color:#E66C5E; font-weight:bold; "> Add a job </div>
<?php
    }
?>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:26%;top:119%; color:#E66C5E; font-weight:bold;"> Add a school or college </div>
<?php
	}
?>
...
<div style="position:absolute;left:19%;top:94%;color:#E66C5E;"> Job </div>
...
<div style="position:absolute;left:19%;top:108%;color:#E66C5E;"> School or College </div>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:60%;top:101%; color:#E66C5E; font-weight:bold;"> Add Your Current City </div>
<?php
	}
?>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:60%;top:119%; color:#E66C5E; font-weight:bold;"> Add your hometown </div>
<?php
	}
?>
...
<div style="position:absolute;left:53%;top:94%;color:#E66C5E;"> Current City </div>
...
<div style="position:absolute;left:53%;top:108%;color:#E66C5E;"> hometown </div>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:27%;top:169.5%; color:#E66C5E; font-weight:bold;"> Add Relationship </div>
<?php
	}
?>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:62%;top:156.4%; color:#E66C5E; font-weight:bold;"> Add Mobile Number </div>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:59%;top:169%; color:#E66C5E; font-weight:bold;"> <?php echo $web; ?> </div>
<?php
	}
	else
	{
?>
		<div style="position:absolute;left:59%;top:169%; color:#E66C5E; font-weight:bold;"> Add Website </div>
<?php
	}
?>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:61%;top:175%; color:#E66C5E; font-weight:bold;"> <?php echo $fb_id; ?> </div>
...
<?php
	...
	{
?>
		<div style="position:absolute;left:61%;top:175%; color:#E66C5E; font-weight:bold;"> Add Facebook ID </div>
<?php
	}
?>
