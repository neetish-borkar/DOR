...
<body>
	...
	<div style="position:absolute; left:25%; top:18%; color:#E66C5E; font-size:24px;"> Name </div>
    ...
    <div style="position:absolute; left:25%; top:35%; color:#E66C5E; font-size:24px;"> Paasword </div>
    ...
    <div style="position:absolute; left:25%; top:47%; "> <input type="button" value="Deactivate your account." style="background:#FFF; color:#E66C5E; font-size:15px; border:none;" onClick="delete_account()"> </div>
...
<div style="position:fixed; background:#E66C5E; left:30%; top:20%; height:10%; width:35%; z-index:3"></div>
