...
<div style="position:fixed; left:47%; top:12%; z-index:3; color:#E66C5E; font-size:48px;">   Notice  </div>
...
<option value="Private"> Only me </option>
	...
	<div style="position:absolute; left:57%; top:28%;"> <input type="submit" value="post" name="txt" id="post_button" onClick="time_get()"
	...
	<div style="position:absolute; left:57%; top:28%;"> <input type="submit" value="post" name="file" id="post_button" onClick="time_get1()"
		style="	font-size:12px;
		height:25;
		width:55;
		padding:2;
...
?>
	...
	?>
 	...
 	<tr>
		<td width="5%" style="padding-left:25;" rowspan="2"> <img src="../../dor_users/<?php echo $user_gender; ?>/<?php echo $user_Email; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
		<td > </td>
		<td> </td>
		<td> </td>
	</tr>
	<tr>
		<td colspan="3" style="padding:7;"> <a href="../dor_view_profile/view_profile.php?id=<?php echo $post_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#E66C5E;" onMouseOver="post_name_underLine(<?php echo $postid; ?>)" onMouseOut="post_name_NounderLine(<?php echo $postid; ?>)" id="uname<?php echo $postid; ?>"> <?php echo $user_name; ?> </a>
			<?php
					$tick=mysqli_query($con,"select * from users where user_id='$post_user_id'");
					$gtick=mysqli_fetch_array($tick);
					$green=$gtick[7];
					if($green=="NGO")
					{
			?>
					<img src="background_file/background_icons/greentick.png" height="15" width="15">
			<?php
			}
			?>
		</td>
...
?>
	<tr>
		<td> </td>
		<td width="4%" bgcolor="#FFFFFF" style="padding-left:12;" rowspan="2">  <img src="../../dor_users/<?php echo $user_gender1; ?>/<?php echo $user_Email1; ?>/Profile/<?php echo $user_pic1; ?>" height="40" width="47">    </td>
		<td bgcolor="#FFFFFF" style="padding-left:7;" > <a href="../dor_view_profile/view_profile.php?id=<?php echo $comment_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#E66C5E;" onMouseOver="Comment_name_underLine(<?php echo $comment_id; ?>)" onMouseOut="Comment_name_NounderLine(<?php echo $comment_id; ?>)" id="cuname<?php echo $comment_id; ?>"> <?php echo $user_name1; ?></a> </td>
	<?php
		if($userid==$post_user_id)
		{ ?>
			<td align="right" rowspan="1" bgcolor="#FFFFFF">
			<form method="post">
		...
		{?>
			<td align="right" rowspan="2" bgcolor="#FFFFFF">  </td>
		<?php
		}
	?>
	...
	<tr>
		<td> </td>
		<td bgcolor="#FFFFFF" style="padding-left:7;" colspan="2"> <?php echo $cline1; ?></td>
	</tr>
	<?php
	}
	...
	<tr>
		...
		<td bgcolor="#FFFFFF" style="padding-left:7;" colspan="2"> <?php echo $cline2; ?></td>
	</tr>
	<?php
	}
	...
	<tr>
		<td> </td>
		<td bgcolor="#FFFFFF"> </td>
		<td bgcolor="#FFFFFF" style="padding-left:7;" colspan="2"> <?php echo $cline3; ?></td>
	</tr>
	<?php
	}
	...
	<tr>
		<td> </td>
		<td bgcolor="#FFFFFF"> </td>
		<td bgcolor="#FFFFFF" style="padding-left:7;" colspan="2"> <?php echo $cline4; ?></td>
	</tr>
	<?php
	}
	...
	<tr>
		<td> </td>
		<td bgcolor="#FFFFFF"> </td>
		<td bgcolor="#FFFFFF" style="padding-left:7;" colspan="2"> <?php echo $cline5; ?></td>
	</tr>
	<?php
	}
	...
	<tr>
		<td> </td>
		<td bgcolor="#FFFFFF"> </td>
		<td bgcolor="#FFFFFF" style="padding-left:7;" colspan="2"> <?php echo $cline6; ?></td>
	</tr>
	<?php
	}
	...
	<tr>
		<td> </td>
		<td bgcolor="#FFFFFF"> </td>
		<td bgcolor="#FFFFFF" style="padding-left:7;" colspan="2"> <?php echo $cline7; ?></td>
	</tr>
	<?php
	}
	?>
	...
	<tr>
	<td> </td>
	<td width="4%" style="padding-left:17;" bgcolor="#FFFFFF" rowspan="2">  <img src="../../dor_users/<?php echo $gender; ?>/<?php echo $user; ?>/Profile/<?php echo $img; ?>" style="height:33; width:33;">    </td>
		<td bgcolor="#FFFFFF" colspan="2" style="padding-top:15;">
