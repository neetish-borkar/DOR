...
<body>
	...
	<div style="position:absolute; left:35%; top:12%;"> <h1 style="color:#E98074;"> Group Chat </h1> </div>
    ...
    <div style="position:absolute; left:59%; top:49.6%;"> <input type="submit" value="Send" name="Message_send" id="chat_button" onClick="time_get()"
...
?>
	...
	<tr>
    	<td style="padding-left:25;" rowspan="2"> <img src="../../dor_users/<?php echo $user_gender; ?>/<?php echo $user_email; ?>/Profile/<?php echo $user_pic; ?>" height="60" width="55">  </td>
        <td colspan="2" style="padding:7;"> <a href="../dor_view_profile/view_profile.php?id=<?php echo $fb_user_id; ?>" style="text-transform:capitalize; text-decoration:none; color:#E66C5E;" onMouseOver="chat_name_underLine(<?php echo $chat_id; ?>)" onMouseOut="chat_name_NounderLine(<?php echo $chat_id; ?>)" id="uname<?php echo $chat_id; ?>"> <?php echo $user_name; ?> </a>   </td>
