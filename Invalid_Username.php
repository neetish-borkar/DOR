...
<div style="position:absolute;left:0;top:0; height:13%; width:100%; z-index:-1; background:#E98074">   </div>
<div style="position:absolute;left:13.5%; top:3.3%; font-size:45; font-weight:900; color:#FFFFFF; font-weight:bold;"> <font face="myFbFont">  DOR </font> </div>

<div style="position:absolute;left:13.6%; top:14.8%;"> <a href="index.php" style="text-decoration:none;"> <input type="button" value="Sign Up" id="singup_button"
style="background:#E98074;
color:#FFFFFF;
...
width:112;
font-weight:bold;
box-shadow:5px 0px 10px 1px rgb(0,0,0);">    </a> </div>
...
<div style="position:absolute; left:27.4%; top:28.2%;">  <font size="4"> DOR Login </font>  </div>
...
<form  method="post">
	...
	<div style="position:absolute;left:49%;top:71.7%; "> <a href="index.php" style="color:#E66C5E;text-decoration:none;"> Sign up for Facebook </a> </div>
	<div style="position:absolute;left:43.5%; top:77.2%; font-size:12px;"> <a href='Forgot_Password.php' style="text-decoration:none; color:#E66C5E;" > Forgot your password? </a> </div>
